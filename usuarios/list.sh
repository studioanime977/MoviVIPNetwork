...
echo -e "${CYAN}â•‘${MAGENTA}                      ðŸ“‹ USUARIOS REGISTRADOS SSH ðŸ“‹                      ${CYAN}â•‘${RESET}"
...
printf "${CYAN}â•‘${WHITE} %-2s ${CYAN}â•‘ ${WHITE}%-16s ${CYAN}â•‘ ${WHITE}%-12s ${CYAN}â•‘ ${WHITE}%-6s ${CYAN}â•‘ ${WHITE}%-24s${CYAN}â•‘${RESET}\n" \
"NÂ°" "USUARIO" "EXPIRA" "DÃAS" "ESTADO"
echo -e "${CYAN}â• â•â•â•â•â•¬â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•¬â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•¬â•â•â•â•â•â•â•â•â•¬â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£${RESET}"
...
printf "${CYAN}â•‘${WHITE} %02d ${CYAN}â•‘ ${WHITE}%-16s ${CYAN}â•‘ ${WHITE}%-12s ${CYAN}â•‘ ${WHITE}%-6s ${CYAN}â•‘ %-33b${CYAN}â•‘${RESET}\n" \
