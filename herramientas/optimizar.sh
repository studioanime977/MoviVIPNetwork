...
CYAN="${MV_CYN:-\e[1;96m}"; GREEN="${MV_GRN:-\e[1;92m}"; YELLOW="${MV_YLW:-\e[1;93m}"; RED="${MV_RED:-\e[1;91m}"
BLUE="${MV_BLU:-\e[1;94m}"; WHITE="${MV_WHT:-\e[1;97m}"; GRAY="${MV_DIM:-\e[1;90m}"; GOLD="${MV_GLD:-\e[1;93m}"; RESET="${MV_R:-\e[0m}"
