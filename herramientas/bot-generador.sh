...
plantilla_render() {
    ...
    local INSTALL="rm -rf /root/install.sh; wget --no-cache -O /root/install.sh https://github.com/studioanime977/MoviVIPNetwork/releases/download/v2.0.2/install.sh; chmod +x /root/install.sh; /root/install.sh"
