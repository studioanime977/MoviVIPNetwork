#!/bin/bash
# MoviVIP Network — Deploy v5.4 (rediseño ADMRufu)
set -u
BASE=/etc/movivip
STG=/tmp/mv54
FAIL=0
...
echo "== 1) Syntax check en staging =="
...
echo "OK: 16 archivos con sintaxis valida"

echo "== 2) Purga backups obsoletos (.pack-backup) =="
for f in $FILES; do
...
echo "Instalacion OK (16 archivos)"

echo "== 4) CRLF + permisos =="
...
echo "== 5) Verificacion de parches =="
ERR=0
