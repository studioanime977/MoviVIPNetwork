...
echo "$(trx '== 4. VERIFICAR PARCHE PRESENTE EN VPS (plain) ==')"
P=0; F=0
for f in openssh systemdns badvpn udpcustom dropbear checkuser ssl slowdns hysteria v2ray zipvpn; do
