...
printf "${GREEN} [02]${WHITE} ➮ Dropbear          [%s]\n" "$DROPBEAR"
printf "${GREEN} [03]${WHITE} ➮ OpenVPN           [%s]\n" "$OPENVPN"
printf "${GREEN} [04]${WHITE} ➮ SSL/TLS           [%s]\n" "$SSL"
printf "${GREEN} [05]${WHITE} ➮ Shadowsocks-R     [%s]\n" "$SHADOWSOCKS"
printf "${GREEN} [06]${WHITE} ➮ Squid Proxy       [%s]\n" "$SQUID"
printf "${GREEN} [07]${WHITE} ➮ Proxy Python      [OFF]\n"
printf "${GREEN} [08]${WHITE} ➮ V2Ray             [%s]\n" "$V2RAY"
printf "${GREEN} [09]${WHITE} ➮ Clash             [OFF]\n"
printf "${GREEN} [10]${WHITE} ➮ Trojan-Go         [%s]\n" "$TROJAN"

echo ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"

printf "${GREEN} [11]${WHITE} ➮ Psiphon Server    [OFF]\n"
printf "${GREEN} [12]${WHITE} ➮ TCP DNS           [OFF]\n"
printf "${GREEN} [13]${WHITE} ➮ Webmin            [%s]\n" "$WEBMIN"
printf "${GREEN} [14]${WHITE} ➮ SlowDNS           [%s]\n" "$SLOWDNS"
printf "${GREEN} [15]${WHITE} ➮ SSL → Python      [OFF]\n"
printf "${GREEN} [16]${WHITE} ➮ SSLH              [OFF]\n"
printf "${GREEN} [17]${WHITE} ➮ Over WebSocket    [%s]\n" "$WEBSOCKET"
printf "${GREEN} [18]${WHITE} ➮ Socks5            [%s]\n" "$SOCKS5"
printf "${GREEN} [19]${WHITE} ➮ UDP Custom        [%s]\n" "$UDP_CUSTOM"
printf "${GREEN} [20]${WHITE} ➮ En desarrollo\n"
echo ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
