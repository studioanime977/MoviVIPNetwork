...
# SlowDNS Manager v3 (ADMRufu-style)
...
#   (mismo binario probado que usa ADMRufu)
...
install_slowdns_binary(){
    ...
    # ── Fuente local: binario dnstt incluido (mismo de ADMRufu) ──
    for LOCAL_SRC in \
...
# Misma receta probada de ADMRufu.
#==================================================
...
#==================================================
# Abrir puerto DNS (v3 ADMRufu-style)
#
...
#
# NOTA: sin u32, sin dnsdist. Igual que ADMRufu:
