...
header "🚀 KEVINTECH • V2RAY MANAGER"

echo -e "${WHITE}Estado      : $STATUS"
echo -e "${WHITE}Dominio     : ${GREEN}${SERVER_DOMAIN:-NO CONFIGURADO}${RESET}"
echo -e "${WHITE}Puerto TLS  : ${GREEN}443${RESET}"
echo -e "${WHITE}WebSocket   : ${GREEN}/vmess${RESET}"
...
cat <<EOF
 ...
 ${GREEN}[02]${RESET} 👤 Crear cuenta VMess
 ${GREEN}[03]${RESET} 📋 Ver usuarios
 ${GREEN}[04]${RESET} 🔗 Generar enlace VMess
 ${GREEN}[05]${RESET} 🔍 Buscar usuario
 ${GREEN}[06]${RESET} 🗑 Eliminar usuario
 ${GREEN}[07]${RESET} 📊 Estado del servicio
 ${GREEN}[08]${RESET} 🔄 Reiniciar Xray
 ${GREEN}[09]${RESET} ❌ Desinstalar Xray

 ${RED}[00]${RESET} ⬅ Regresar
