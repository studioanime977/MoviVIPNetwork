...
OPERATORS = {
    # ═══════════════════════════════════════════════════════════════════
    # OPERADORAS — DATOS EXCLUSIVOS DEL VENDEDOR (NO SE PUBLICAN).
    # Los payloads, SNIs y hosts de operadoras son confidenciales del
    # vendedor y NO deben subirse al repo (misma política que config.py).
    # Se cargan en el servidor del cliente durante la instalación.
    # ═══════════════════════════════════════════════════════════════════
}
